...
CGGradientRef CreateGradientRefWithColors(CGColorSpaceRef colorSpace, UIColor *startColor, UIColor *endColor)
{
  ...
  NSArray *colorsArray = @[(__bridge id)startColor.CGColor, (__bridge id)endColor.CGColor];
  return CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)colorsArray, colorStops);
}
